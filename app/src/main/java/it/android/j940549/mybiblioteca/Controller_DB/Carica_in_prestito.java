...
import it.android.j940549.mybiblioteca.Activity_Utente.fragment_prestiti.MyRecyclerViewAdapter_in_prestito;
...
public class Carica_in_prestito extends AsyncTask<String,String,String> {
    Activity myActivity;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private ProgressDialog progressDialog;
    ArrayList<Libri_In_Prestito> mDataset;
    private Utente utenteLogin;

    public Carica_in_prestito(Activity myActivity, RecyclerView mRecyclerView, RecyclerView.Adapter mAdapter, Utente utenteLogin){
    ...
    protected void onPostExecute(String result) {
        ...
        try{
            ...
            mAdapter = new MyRecyclerViewAdapter_in_prestito(mDataset,myActivity,utenteLogin);

...
public class Inserisci_new_Utente_inDB extends AsyncTask<String,String,String> {

    private Activity myActivity;
    private ProgressDialog progressDialog;
    private boolean registrato;

    public Inserisci_new_Utente_inDB(Activity myActivity){
...
//        progressDialog.show();
    ...
    protected void onPostExecute(String result) {
        ...
        if (registrato == true) {
            Intent vaiaLogin = new Intent(myActivity, Login_Ute_Ges_Activity.class);

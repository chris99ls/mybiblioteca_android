...
public class LoginUtenteFragment extends Fragment {
    ...
    private ImageButton fp_button, btn_new_user;
    ...
    public static LoginUtenteFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_new_user= view.findViewById(R.id.add_new_utente);
        btn_new_user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(),Add_new_UtenteActivity.class);
